...
$app_name = str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
$url_domain = $root . $app_name;

define('ROOT', $root);
define('IMGROOT', $_SERVER['DOCUMENT_ROOT'].'/image/');
