      ...
      var s = $(r),
        ...
        f = {
          ...
          _unbindInput: function (all) {
            ...
            if (all) {
              ...
              if (n.dragDrop) {
                ...
                n.dragDrop.dragContainer.off(
                  "dragleave",
                  f._dragDrop.dragLeave
                );
              }
              if (n.uploadFile && n.clipBoardPaste) {
          ...
          _changeInput: function () {
            ...
            if (n.dragDrop) {
              n.dragDrop.dragContainer = n.dragDrop.dragContainer
                ? $(n.dragDrop.dragContainer)
                : o;
            }
          ...
          _filesCheck: function () {
            ...
            if (n.limit && f.files.length + f._itFl.length > n.limit) {
              n.dialogs.alert(
                f._assets.textParse(n.captions.errors.filesLimit)
              );
              return false;
            }
            for (var t = 0; t < f.files.length; t++) {
              ...
              if (
                n.extensions != null &&
                $.inArray(x, n.extensions) == -1 &&
                $.inArray(m.type, n.extensions) == -1
              ) {
                n.dialogs.alert(
                  f._assets.textParse(n.captions.errors.filesType, m)
                );
                return false;
              }
              if (
                (n.maxSize != null && f.files[t].size > n.maxSize * 1048576) ||
                (n.fileMaxSize != null &&
                  f.files[t].size > n.fileMaxSize * 1048576)
              ) {
                n.dialogs.alert(
                  f._assets.textParse(n.captions.errors.filesSize, m)
                );
                return false;
              }
              if (file.size == 4096 && file.type.length == 0) {
                n.dialogs.alert(
                  f._assets.textParse(n.captions.errors.folderUpload, m)
                );
                return false;
              }
              if (
                n.onFileCheck != null && typeof n.onFileCheck == "function"
                  ? n.onFileCheck(m, n, f._assets.textParse) === false
                  : null
              ) {
                return false;
              }
            ...
            if (n.maxSize != null && s >= Math.round(n.maxSize * 1048576)) {
              n.dialogs.alert(
                f._assets.textParse(n.captions.errors.filesSizeAll)
              );
              return false;
            }
            return true;
            ...
            create: function (i) {
              var file = f.files[i],
                ...
                opts = {
                  ...
                  image:
                    '<div class="jFiler-item-thumb-image fi-loading" style="text-align: center"></div>',
              ...
              $(".jFiler-item[data-jfiler-index='" + id + "']")
                .find(n.templates._selectors.remove)
            ...
            renderFile: function (file, html, opts) {
              ...
              if (file.file && opts.type == "image") {
                var g =
                    '<img src="' +
                    file.file +
                    '" class="url_image" style="max-width: 200px; left: 50%;" draggable="false" onclick="showMarkerArea(this)" />',
                ...
                y.onload = function (e) {
                  ...
                  if (n.templates.canvasImage) {
                    ...
                    img.onerror = function () {
                      html.addClass("jFiler-no-thumbnail");
                      m.removeClass("fi-loading").html(
                        f._thumbCreator.generateIcon(opts)
                      );
                    };
                    img.src = e.target.result;
                  } else {
                    var image, canvas, context, newDataUrl;

                    var imageType = "image/jpeg";
                    var imageArguments = 0.5;
                    ...
                    image.onload = function(){
                      ...
                      m.removeClass("fi-loading").html(
                        '<img src="' +
                          newDataUrl +
                          '" draggable="false" class="url_image" style="max-width: 200px; left: 50%;" onclick="showMarkerArea(this)" />'
                      );
                    }
                  }
                };
            ...
            generateIcon: function (obj) {
              ...
              if (m[2] == 1) {
                ...
                if (c) {
                  ...
                  j.css(
                    "background-color",
                    f._assets.text2Color(obj.extension)
                  );
                  el = j.prop("outerHTML");
                  j.remove();
                }
            ...
            _box: async function (params) {
              ...
              if (l.length < 1) {
                ...
                l.on("click", n.templates._selectors.remove, function (e) {
                  e.preventDefault();
                  var id = $(this).attr("data-jfiler-index");
                  var m = [
          ...
          _upload: function (i) {
            ...
            formData.append(
              s.attr("name"),
              c.file,
              c.file.name ? c.file.name : false
            );
            if (
              n.uploadFile.data != null &&
              $.isPlainObject(
                typeof n.uploadFile.data == "function"
                  ? n.uploadFile.data(c.file)
                  : n.uploadFile.data
              )
            ) {
          ...
          _onSelect: function (i) {
            if (n.uploadFile && !$.isEmptyObject(n.uploadFile)) {
              if (
                !n.uploadFile.synchron ||
                (n.uploadFile.synchron &&
                  $.grep(f._itFl, function (a) {
                    return a.ajax;
                  }).length == 0)
              ) {
          ...
          _remove: function (e, el) {
                ...
                if (
                  ...
                  for (var i = 0; i < f._itFr.length; i++) {
                    if (n.addMore && f._itFr[i] == item && m.length > 0) {
                      f._itFr[i].remove_name =
                        m.indexOf(item) + "://" + f._itFr[i].file.name;
                    }
                    val.push(
                      f._itFr[i].remove_name
                        ? f._itFr[i].remove_name
            ...
            if (
              n.onRemove != null && typeof n.onRemove == "function"
                ? n.onRemove(el, f._itFl[id].file, id, l, p, o, s) !== false
                : true
            ) {
              callback(el, id);
            }
