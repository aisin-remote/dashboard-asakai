...
(function (d) {
	...
	D(
		...
		function (b, c, h, a, f) {
			function w(g, k, e, a, G) {
				...
				q(a) &&
					q(G) &&
					((g = Math.atan2(r(k - v, 8), r(g - E, 8))),
					G !== a &&
						(m =
							a > G
								? (g >= a && g <= Math.PI) || (g <= G && g >= -Math.PI)
								: g >= a && g <= r(G, 8)));
			...
			f = (function () {
				...
				g.prototype.render = function () {
					...
					this.group ||
						(this.group = a
							.g("pane-group")
							.attr({ zIndex: k.zIndex || 0 })
							.add());
					this.updateCenter();
					if (g)
						for (
							g = e(g),
								k = Math.max(g.length, this.background.length || 0),
								a = 0;
							a < k;
							a++
						)
							g[a] && this.axis
								? this.renderBackground(
										p(this.defaultBackgroundOptions, g[a]),
										a
								  )
								: this.background[a] &&
				...
				g.prototype.renderBackground = function (g, e) {
					var k = "animate",
						m = { class: "highcharts-pane " + (g.className || "") };
					...
					? ((e.hoverPane = e.getHoverPane(g)),
					  (g.filter = function (k) {
							return (
								...
								l(k.options.enableMouseTracking, !0) &&
								(!e.hoverPane || k.xAxis.pane === e.hoverPane)
							);
					  }))
					: (e.hoverPane = void 0);
			});
			d(a, "afterGetHoverData", function (g) {
				...
				g.hoverPoint &&
					...
					g.hoverPoint.plotY &&
					e.hoverPane &&
					!w(g.hoverPoint.plotX, g.hoverPoint.plotY, e.hoverPane.center) &&
					(g.hoverPoint = void 0);
			});
			h.Pane = f;
			return h.Pane;
				...
				a.prototype.drawDataLabels = function () {
					...
					if (a) {
						...
						if (c.enabled || this._hasPointLabels) {
							for (b = g; b--; )
								if ((x = e[b])) {
									...
									x.below = t;
									m
										? c.align || (c.align = t ? "right" : "left")
										: c.verticalAlign ||
										  (c.verticalAlign = t ? "top" : "bottom");
								}
							this.options.dataLabels = c;
							r.drawDataLabels && r.drawDataLabels.apply(this, arguments);
							for (b = g; b--; )
								if ((x = e[b]))
									(x.dataLabelUpper = x.dataLabel),
										(x.dataLabel = k[b]),
										delete x.dataLabels,
										(x.y = x.low),
										(x.plotY = x._plotY);
							...
							for (b = g; b--; )
								if ((x = e[b]))
									(k = x.plotHigh),
										...
										(x.below = !t),
										m
											? y.align || (y.align = t ? "left" : "right")
											: y.verticalAlign ||
											  (y.verticalAlign = t ? "bottom" : "top");
						...
						if (c.enabled)
							for (b = g; b--; )
								if ((x = e[b]))
									x.dataLabels = [x.dataLabelUpper, x.dataLabel].filter(
										function (e) {
											return !!e;
										}
									);
						...
						this.points.forEach(function (a) {
							...
							a.isNull
								...
								: ((a.plotLow = m),
								  (a.plotHigh = e(k)
										? g.yAxis.translate(
												g.dataModify ? g.dataModify.modifyValue(k) : k,
												!1,
												!0,
												void 0,
												!0
					...
					this.points.forEach(function (g) {
						if (e.chart.polar)
							e.highToXY(g),
								(g.plotLow = g.plotY),
								(g.tooltipPos = [
									((g.plotHighX || 0) + (g.plotLowX || 0)) / 2,
									((g.plotHigh || 0) + (g.plotLow || 0)) / 2,
								]);
						else {
				...
				c.prototype.drawPoints = function () {
					...
					a.points.forEach(function (m) {
						var t = m.graphic,
							...
							u = {},
							C = m.color || a.color;
						"undefined" !== typeof m.plotY &&
							((n = Math.round(N.width)),
							(I = Math.floor(N.x)),
							(K = I + n),
							(x = Math.round(n / 2)),
							(k = Math.floor(B ? m.q1Plot : m.lowPlot)),
							(c = Math.floor(B ? m.q3Plot : m.lowPlot)),
							(f = Math.floor(m.highPlot)),
							(h = Math.floor(m.lowPlot)),
							t ||
								((m.graphic = t = g.g("point").add(a.group)),
								(m.stem = g.path().addClass("highcharts-boxplot-stem").add(t)),
								H &&
									(m.whiskers = g
										.path()
								...
								(m.medianShape = g
									...
									.add(t))),
							e.styledMode ||
								((l.stroke = m.stemColor || b.stemColor || C),
								(l["stroke-width"] = r(m.stemWidth, b.stemWidth, b.lineWidth)),
								(l.dashstyle =
									m.stemDashStyle || b.stemDashStyle || b.dashStyle),
								m.stem.attr(l),
								H &&
									((w.stroke = m.whiskerColor || b.whiskerColor || C),
									(w["stroke-width"] = r(
										m.whiskerWidth,
										b.whiskerWidth,
										b.lineWidth
									...
									(w.dashstyle =
										m.whiskerDashStyle || b.whiskerDashStyle || b.dashStyle),
									m.whiskers.attr(w)),
								B &&
									((L.fill = m.fillColor || b.fillColor || C),
									(L.stroke = b.lineColor || C),
									(L["stroke-width"] = b.lineWidth || 0),
									(L.dashstyle =
										m.boxDashStyle || b.boxDashStyle || b.dashStyle),
									m.box.attr(L)),
								(u.stroke = m.medianColor || b.medianColor || C),
								(u["stroke-width"] = r(
									m.medianWidth,
									b.medianWidth,
									b.lineWidth
								...
								(u.dashstyle =
									m.medianDashStyle || b.medianDashStyle || b.dashStyle),
								m.medianShape.attr(u)),
							(E = (m.stem.strokeWidth() % 2) / 2),
							(v = I + x + E),
							(t = [
								["M", v, c],
								["L", v, f],
							...
							B &&
								...
								m.box[G]({ d: t })),
							H &&
								((E = (m.whiskers.strokeWidth() % 2) / 2),
								(f += E),
								(h += E),
								(y = /%$/.test(H) ? (x * parseFloat(H)) / 100 : H / 2),
								(t = [
									["M", v - y, f],
									["L", v + y, f],
									["M", v - y, h],
								...
								m.whiskers[G]({ d: t })),
							(d = Math.round(m.medianPlot)),
							(E = (m.medianShape.strokeWidth() % 2) / 2),
							(d += E),
							(t = [
								["M", I, d],
								["L", K, d],
			...
			b = (function () {
				...
				a.prototype.setOptions = function () {
					...
					a.forEach(function (g, k) {
						l ||
							((h.stroke = p(g.borderColor, e.borderColor, b.color)),
							(h.fill = p(
								g.color,
								e.color,
								1 !== v ? f(b.color).setOpacity(v).get("rgba") : b.color
							)),
							(d.stroke = p(g.connectorColor, e.connectorColor, b.color)));
						a[k].radius = this.getRangeRadius(g.value);
						a[k] = F(a[k], { center: a[0].radius - a[k].radius + c });
						l ||
							F(!0, a[k], {
								bubbleAttribs: F(h),
				...
				a.prototype.renderRange = function (a) {
					...
					h.bubbleItems.push(
						f
							.circle(B, d + ((y % 1 ? 1 : 0.5) - (x % 2 ? 0 : 0.5)), l)
							.attr(t ? {} : a.bubbleAttribs)
							.addClass(
								(t ? "highcharts-color-" + c.colorIndex + " " : "") +
					...
					a = f
						.text(this.formatLabel(a), n, K + H)
						.attr(t ? {} : a.labelAttribs)
						.css(t ? {} : g.style)
						.addClass(
					...
					a.chart.series.forEach(function (a) {
						a.isBubble &&
							...
							b.length &&
								...
								(f = p(a.options.zMax, Math.max(f, n(b))))));
					});
					var h =
						c === f
							? [{ value: f }]
					...
					if (k.group) {
						...
						if ((f = a.movementX) || (b && a.ranges))
							(f = b ? g - a.options.maxSize / 2 : g + f),
								k.group.attr({ translateX: f });
						x > e[m].step && m++;
						k.group.attr({ translateY: Math.round(c + e[m].height / 2) });
						k.y = c + e[m].height / 2;
					}
				});
			}
		...
		function (b, c, h, a, f, d) {
			function n() {
					...
					if (
						...
						if (0 < k)
							for (var B = x.length; B--; )
								if (N(x[B]) && a.dataMin <= x[B] && x[B] <= a.max) {
				...
				l &&
					...
					!this.logarithmic &&
					((d -= e),
					(h *= (e + Math.max(0, m) - Math.min(d, e)) / e),
					[
						["min", "userMin", m],
						["max", "userMax", d],
					].forEach(function (e) {
						"undefined" === typeof L(a.options[e[0]], a[e[1]]) &&
							(a[e[0]] += e[2] / h);
					}));
			}
			var w =
			...
			d = (function (a) {
					...
					if (!g) {
						...
						this.chart.series.forEach(function (e) {
							e.bubblePadding &&
								...
								((d = Math.min(d || e.zMin, e.zMin)),
								(h = Math.max(h || e.zMax, e.zMax)),
								(l = !0));
						});
						l
							? ((g = { zMin: d, zMax: h }), (this.chart.bubbleZExtremes = g))
							: (g = { zMin: 0, zMax: 0 });
					}
					var n = 0;
				...
				c.prototype.getRadius = function (a, e, b, c, g, f) {
					...
					if (N(g)) {
						x.sizeByAbsoluteValue &&
							((g = Math.abs(g - m)),
							(d = Math.max(e - m, Math.abs(a - m))),
							(a = 0));
						if (g < a) return b / 2 - 1;
						0 < d && (h = (g - a) / d);
					}
				...
				c.prototype.getZExtremes = function () {
					...
					if (b.length) {
						...
						a = L(a.zMax, e(b));
						if (N(c) && N(a)) return { zMin: c, zMax: a };
					}
				};
		...
		function (b, c, d, a) {
			...
			a = (function (a) {
				...
				b.prototype.setOptions = function () {
					l(!0, arguments[0], { stacking: void 0 });
					...
					this.points.forEach(function (B) {
						...
						p(H) &&
							...
							k && a.polar
								? ((m = B.barX + g),
								  (B.shapeType = "arc"),
								  (B.shapeArgs = a.polar.arc(l + h, l, m, m + B.pointWidth)))
								: ((t.height = h),
								  (t.y = l),
								  (y = t.x),
								  (y = void 0 === y ? 0 : y),
								  ...
								  (B.tooltipPos = f.inverted
										? [
												b.len + b.pos - f.plotLeft - l - h / 2,
												c.len + c.pos - f.plotTop - y - t / 2,
												h,
										  ]
										: [
												c.left - f.plotLeft + y + t / 2,
												b.pos - f.plotTop + l + h / 2,
												h,
										  ])));
					});
				};
				...
				h.prototype.translate = function () {
					...
					a.points.forEach(function (c) {
						...
						c.tooltipPos = b.inverted
							? [k.len + k.pos - b.plotLeft - m, a.xAxis.len - f - y, g]
							: [f + y, m + k.pos - b.plotTop, g];
						m = h + (c.total || c.y);
						"percent" === e.stacking && (m = h + (0 > c.y) ? -100 : 100);
						m = k.toPixels(m, !0);
						var J = (t = b.plotHeight - m - (b.plotHeight - n))
							? (y * (l - m)) / t
							: 0;
						var w = t ? (y * (l + g - m)) / t : 0;
						t = f - J + y;
					...
					this.points.forEach(function (g) {
						...
						if (q(B) || !1 === b.wrap)
							(B = q(B) ? (B / 180) * Math.PI : 0),
								(y = r(y, a.startAngleRad - B, a.endAngleRad + B));
						y = (180 * y) / Math.PI;
						g.shapeType = "path";
						g.shapeArgs = {
							d: f.path || [
		...
		function (b) {
			function c() {
				var a = this,
					...
					h;
				a.container &&
					(b = d(a.container, "mousedown", function (b) {
						var f = a.hoverPoint;
						f &&
							f.series &&
							...
							(c = d(a.container, "mousemove", function (a) {
				...
				onMouseMove: function (a, b) {
					if (a.fixedPosition && a.inDragMode) {
						...
						if (5 < Math.abs(b) || 5 < Math.abs(f))
							(h = a.fixedPosition.plotX - b),
								(w = a.fixedPosition.plotY - f),
								c.isInsidePlot(h, w) &&
									((a.plotX = h),
									(a.plotY = w),
									(a.hasDragged = !0),
				...
				barycenter: function () {
					for (
						...
						this.options.splitSeries && !q.isParentNode
							? ((d = q.series.parentNode.plotX),
							  (n = q.series.parentNode.plotY))
							: ((d = a.width / 2), (n = a.height / 2));
						q.fixedPosition ||
							((q.plotX -=
								((q.plotX - d) * b) / (q.mass * Math.sqrt(c.length))),
							(q.plotY -=
								((q.plotY - n) * b) / (q.mass * Math.sqrt(c.length))));
					}
				},
				getK: b.noop,
			...
			b.prototype.updateMassAndCenter = function () {
				...
				if (this.isInternal) {
					for (var f = 0, w = this.nodes; f < w.length; f++) {
						var n = w[f];
						n.isEmpty ||
							((b += n.mass), (d += n.plotX * n.mass), (a += n.plotY * n.mass));
					}
					d /= b;
					a /= b;
				} else
	...
	D(
		...
		function (b) {
			return (function () {
				function c(c, a, d, w) {
					this.box = { left: c, top: a, width: d, height: w };
					this.maxDepth = 25;
		...
		function (b, c, d, a, f, w) {
			...
			return (function () {
				...
				c.prototype.init = function (a) {
					...
					this.attractiveForce = p(
						a.attractiveForce,
						this.integration.attractiveForceFunction
					);
					this.repulsiveForce = p(
						a.repulsiveForce,
				...
				c.prototype.setCircularPositions = function () {
						...
						var a = this.box,
							...
							l = function (a) {
								...
								for (a = a.linksFrom || []; b < a.length; b++) {
									var c = a[b];
									f[c.toNode.id] ||
										((f[c.toNode.id] = !0), E.push(c.toNode), l(c.toNode));
								}
							},
							E = [],
							v = 0;
					...
					if (E.length)
						for (d = 0; d < b.length; d++)
							(v = b[d]), -1 === E.indexOf(v) && E.push(v);
					else E = b;
					d = 0;
					for (v = E.length; d < v; ++d)
						(b = E[d]),
							(b.plotX = b.prevX =
								p(b.plotX, a.width / 2 + h * Math.cos(d * c))),
							(b.plotY = b.prevY =
								p(b.plotY, a.height / 2 + h * Math.sin(d * c))),
							(b.dispX = 0),
							(b.dispY = 0);
				};
				c.prototype.setRandomPositions = function () {
					for (
						...
						(f = b[h]),
							(f.plotX = f.prevX = p(f.plotX, a.width * d(h))),
							(f.plotY = f.prevY = p(f.plotY, a.height * d(c + h))),
							(f.dispX = 0),
							(f.dispY = 0);
				};
					...
					if ("barnes-hut" === this.approximation)
						...
						for (var l = 0, E = this.nodes; l < E.length; l++) {
							...
							for (var v = 0, q = this.nodes; v < q.length; v++) {
								...
								h === n ||
									h.fixedPosition ||
									((f = this.getDistXY(h, n)),
									(d = this.vectorLength(f)),
									0 !== d &&
										((b = this.repulsiveForce(d, this.k)),
										this.force("repulsive", h, b * n.mass, f, d)));
							}
						}
					}
				};
		...
		function (b, c, d, a, f, w, n, r, q) {
			...
			q = (function (a) {
				...
				b.prototype.addLayout = function () {
					...
					var g = e[b];
					g ||
						((a.enableSimulation = m(c.forExport)
							? !c.forExport
							: a.enableSimulation),
				...
				b.prototype.drawDataLabels = function () {
					...
					this.parentNode &&
						...
						l.drawDataLabels.call(this, [this.parentNode]));
				};
					...
					if (a.length) {
						...
						if (1 < a.length)
							for (
								...
								(a[k][2] = a[k][2] || 1),
									(h = c(e[d][f], e[d - 1][g], a[k])),
									b(h, e[d][0])
										? (e.push([]),
										  (g = 0),
										  e[d + 1].push(c(e[d][f], e[d][0], a[k])),
										  d++,
										  (f = 0))
										: 1 < d && e[d - 1][g + 1] && b(h, e[d - 1][g + 1])
										? (g++, e[d].push(c(e[d][f], e[d - 1][g], a[k])), f++)
										: (f++, e[d].push(h));
						this.chart.stages = e;
				...
				b.prototype.resizeRadius = function () {
					...
					if (1e-10 < Math.abs(c - 1)) {
						...
						(a.diffY = g / 2 + f - k - (m - k) / 2),
							(a.diffX = h / 2 + d - l - (u - l) / 2);
				};
			...
			a = (function (a) {
							...
							if (a) {
								if (f) {
									...
									if ("overlap" === a) {
										...
										0 <= r
											? ((w = A.threshold + A.posTotal), (A.posTotal -= r))
											: ((w = A.threshold + A.negTotal),
											  (A.negTotal -= r),
											  (w -= r)),
											!A.posTotal &&
												g(A.absolutePos) &&
									...
									if ((r = b.waterfall.dummyStackItem))
										(r.x = t),
											(r.label = f[t].label),
											r.setOffset(
												this.pointXOffset || 0,
								...
								(w = Math.max(k, k + r) + A[0]),
									(p.y = b.translate(w, !1, !0, !1, !0)),
									l.isSum
										? ((p.y = b.translate(A[1], !1, !0, !1, !0)),
										  (p.height =
										...
										? (0 <= r
												? ((n = A[1] + h), (r = h))
												: ((n = h), (r = A[1] + h)),
										  b.reversed && ((n ^= r), (r ^= n), (n ^= r)),
										  (p.y = b.translate(n, !1, !0, !1, !0)),
										  (p.height = Math.abs(
												p.y - Math.min(b.translate(r, !1, !0, !1, !0), b.len)
										  )),
										  (h += A[1]),
										  (l.below = n <= d))
										: ((p.height =
												0 < n
													? b.translate(k, !1, !0, !1, !0) - p.y
													: b.translate(k, !1, !0, !1, !0) -
													  b.translate(k - n, !1, !0, !1, !0)),
										  (k += n),
										  (l.below = k < d)),
									0 > p.height && ((p.y += p.height), (p.height *= -1));
							l.plotY = p.y = Math.round(p.y || 0) - (this.borderWidth % 2) / 2;
							p.height = Math.max(Math.round(p.height || 0), 0.001);
							l.yBottom = p.y + p.height;
							p.height <= c && !l.isNull
								? ((p.height = c),
								  (p.y -= e),
								  (l.plotY = p.y),
								  (l.minPointLengthOffset = 0 > l.y ? -e : e))
								: (l.isNull && (p.width = 0), (l.minPointLengthOffset = 0));
							r = l.plotY + (l.negative ? p.height : 0);
							l.below && (l.plotY += p.height);
							l.tooltipPos &&
								(this.chart.inverted
									? (l.tooltipPos[0] = b.len - r)
									: (l.tooltipPos[1] = r));
				...
				b.prototype.processData = function (b) {
					...
					for (n = l = k = m = t = 0; n < g; n++) {
						...
						"sum" === q || p.isSum
							? (d[n] = e(l))
							: "intermediateSum" === q || p.isIntermediateSum
							? ((d[n] = e(k)), (k = 0))
							: ((l += q), (k += q));
						m = Math.min(l, m);
						t = Math.max(l, t);
						...
						p &&
							...
							h
								? ((p = p.connectorThreshold),
								  (r =
										Math.round(b.translate(p, !1, !0, !1, !0) + (g ? r : 0)) -
										e))
								: (r = q.y + n.minPointLengthOffset + d - e),
							k.push(
								["M", (q.x || 0) + (f ? 0 : q.width || 0), r],
								["L", (m.x || 0) + (f ? m.width || 0 : 0), r]
							));
						q &&
							k.length &&
							((!h && 0 > n.y && !g) || (0 < n.y && g)) &&
				...
				b.prototype.getExtremes = function () {
					...
					if (a) {
						...
						return { dataMin: l(c), dataMax: p(e) };
					}
			...
			(function (a) {
				...
				function K(a, b, c) {
					...
					if ("polygon" === this.options.gridLineInterpolation)
						...
						b = this.translate(b);
						z || ((n = a || 0), (P = b || 0));
						if ("circle" !== c.shape && z) (c = h + (a || 0)), (h += b || 0);
						else {
							c = -Math.PI / 2;
							h = 1.5 * Math.PI;
							var q = !0;
						...
						z &&
							((z = (h + c) / 2),
							(l = l + g[0] + (g[2] / 2) * Math.cos(z)),
							(k.xBounds =
								z > -Math.PI / 2 && z < Math.PI / 2
									? [l, d.plotWidth]
									: [0, l]),
							(k.yBounds = [m + g[1] + (g[2] / 2) * Math.sin(z)]),
							(k.yBounds[0] +=
				...
				function x(a) {
					...
					q = q.y;
					z &&
						((q = this.getCrosshairPosition(a, l, m)),
						(n = q[0]),
						(p = q[1]),
						(q = q[2]));
					if (this.isCircular)
						(n = Math.sqrt(Math.pow(p - l, 2) + Math.pow(q - m, 2))),
							(f = "string" === typeof C ? g(C, 1) : C / n),
							(e = "string" === typeof k ? g(k, 1) : k / n),
							c && h && ((h /= n), f < h && (f = h), e < h && (e = h)),
							(c = [
								["M", l + f * (p - l), m - f * (m - q)],
								["L", p - (1 - e) * (p - l), q + (1 - e) * (m - q)],
							]);
					else if (
						((n = this.translate(n)) && (0 > n || n > u) && (n = 0),
						"circle" === this.options.gridLineInterpolation)
					)
						c = this.getLinePath(0, n, h);
					else if (
						((c = []),
						...
						for (
							...
							(h = P.getPosition(l[m], n)),
								c.push(m ? ["L", h.x, h.y] : ["M", h.x, h.y]);
					return c;
				}
				function B(a, b) {
					a = this.translate(a);
				...
				function U(a) {
					...
					var u;
					if ("colorAxis" === k) this.isRadial = !1;
					else {
						if (d) {
							if (
								(n
									? ((this.isHidden = !0),
									  (this.createLabelCollector = m),
									  (this.getOffset = h),
							...
							f &&
								(H(this),
								(this.defaultPolarOptions = (u = this.horiz)
									? X
									: l(
											"xAxis" === k
						...
						if (c.isRadial) {
							...
							if (
								...
								15 > z || (180 <= z && 195 > z)
									? (O = 0.3 * d.height)
									: 15 <= z && 35 >= z
									? (O = "start" === n ? 0 : 0.75 * d.height)
									: 195 <= z && 215 >= z
									? (O = "start" === n ? 0.75 * d.height : 0)
									: 35 < z && 90 >= z
									? (O = "start" === n ? 0.25 * -d.height : d.height)
									: 215 < z &&
									  270 >= z &&
									  (O = "start" === n ? d.height : 0.25 * -d.height);
								15 > p
									? (t = "start" === n ? 0.15 * -d.height : 0.15 * d.height)
									: 165 < p &&
									  180 >= p &&
									  (t = "start" === n ? 0.15 * d.height : 0.15 * -d.height);
								b.attr({ align: u });
				...
				a.compose = function (a, b) {
					-1 === T.indexOf(a) &&
						(T.push(a),
						n(a, "afterInit", t),
						n(a, "autoLabelAlign", J),
						n(a, "destroy", N),
						n(a, "init", U),
						n(a, "initialAxisTranslation", A));
					-1 === T.indexOf(b) &&
						(T.push(b),
						n(b, "afterGetLabelPosition", M),
						n(b, "afterGetPosition", S),
						k(b.prototype, "getMarkPath", W));
					return a;
				};
			})(m || (m = {}));
			return m;
				...
				if (b.polar && b.hoverPane && b.hoverPane.axis) {
					...
					if (this.zoomHor) {
						...
						"polygon" === n.options.gridLineInterpolation &&
							((r = b.hoverPane.axis),
							(p = h - r.startAngleRad + r.pos),
							(t -= h),
							(q = n.getPlotLinePath({ value: n.max })),
							(h = r.toValue(p)),
							(p = r.toValue(p + t)),
							h < r.getExtremes().min &&
								((t = r.getExtremes()), (h = t.max - (t.min - h))),
							p < r.getExtremes().min &&
								((t = r.getExtremes()), (p = t.max - (t.min - p))),
							p < h && (p = [h, (h = p)][0]),
							(q = k(q, h, p, r)),
							q.push(["L", c[0] + b.plotLeft, b.plotTop + c[1]]),
							(u.d = q),
							(q = "path"));
					}
					this.zoomVert &&
						...
						f > c[2] / 2 && (f = c[2] / 2),
						d < c[3] / 2 && (d = c[3] / 2),
						this.zoomHor || ((u.start = l), (u.end = m)),
						(u.r = f),
						(u.innerR = d),
					...
					this.zoomHor &&
						...
						u.d instanceof Array &&
							((c = u.d.slice(0, u.d.length / 2)),
							(l = u.d.slice(u.d.length / 2, u.d.length)),
							(l = K([], l, !0).reverse()),
							(b = b.hoverPane.axis),
							(c = k(c, h, p, b)),
							(l = k(l, h, p, b)) && (l[0][0] = "L"),
					...
					for (var b = this.points, d = b.length; d--; )
						this.preventPostTranslate || this.polar.toXY(b[d]),
							a.hasParallelCoordinates ||
								this.yAxis.reversed ||
								(J(b[d].y, Number.MIN_VALUE) < this.yAxis.min ||
				...
				if (e.isRadial) {
					...
					for (; e--; ) {
						...
						if (d.inverted) {
							...
							c && g.stacking
								? ((x = g.stacking.stacks[(0 > x ? "-" : "") + this.stackKey]),
								  this.visible &&
										x &&
										x[w] &&
										!b.isNull &&
										((q =
											x[w].points[
												this.getStackIndicator(void 0, w, this.index).key
											]),
										(p = g.translate(q[0])),
										(q = g.translate(q[1])),
										y(p) && (p = f.clamp(p, 0, m))))
							...
							b.plotY =
								(y(this.translatedThreshold) &&
									(p < this.translatedThreshold ? p : q)) - l;
						} else
							(p = v + l),
								...
								if (!b) {
									...
									d.points.forEach(function (a) {
										...
										n &&
											p &&
											(n.attr({ r: t, innerR: t }),
											n.animate({ r: q, innerR: r }, d.options.animation));
									});
								}
							} else
								b
					...
					? d
						? ((a = h(b, d, !0, this.connectEnds)),
						  ...
						  (a = [
								...
								t(b) ? b : a.plotX,
								t(c) ? c : a.plotY,
								t(a.leftContX) ? a.leftContX : a.plotX,
								t(a.leftContY) ? a.leftContY : a.plotY,
								a.plotX,
								a.plotY,
						  ]))
						: (a = ["M", c.plotX, c.plotY])
				...
				S = (function () {
					...
					b.compose = function (b, c, d, f, g, h, k, t, u) {
						...
						-1 === M.indexOf(d) &&
							(M.push(d),
							(b = d.prototype),
							A(b, "getCoordinates", E),
							A(b, "pinch", v),
							B(d, "getSelectionMarkerAttrs", p),
						...
						k &&
							...
							(M.push(k),
							(d = k.prototype),
							A(d, "alignDataLabel", N),
							A(d, "animate", Q),
							A(d, "translate", G));
						t &&
							-1 === M.indexOf(t) &&
							(M.push(t), A(t.prototype, "getGraphPath", L));
						u &&
							-1 === M.indexOf(u) &&
							(M.push(u),
							(t = u.prototype),
							A(t, "getPointSpline", I),
							h &&
								-1 === M.indexOf(h) &&
								(M.push(h), (h.prototype.getPointSpline = t.getPointSpline)));
					};
